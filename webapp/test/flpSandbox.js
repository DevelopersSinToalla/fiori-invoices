		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#trialdevsinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trialdevsinvoices-display": {
								"semanticObject": "trialdevsinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=trialdevs.invoices",
									"url": sap.ui.require.toUrl("trialdevs/invoices")
								}
							}
						}
					}
